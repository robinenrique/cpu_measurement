...
'''
	...
	EMAIL TO HIREGROUND IF THEY ARE TOO HIGH.
...
SENDER = 'serveralert@hiregroundsoftware.com'
RECEIVER = 'alerts@hiregroundsoftware.com'

def printCPU(overloadCPU):
	#MESSAGE = "From: CPU Notification Center <serveralert@hiregroundsoftware.com>
	#To: Alerts <serveralert@hiregroundsoftware.com>
...
'''
	...
	THE EMAIL THROUGH HIREGROUND.COM
'''
def sendMail(overload, indicator):
	try:	
		...
		server.ehlo()
		server.starttls()
		server.login("serveralert@hiregroundsoftware.com", "HireGround1234")
		if indicator == 1:
